...
public:
	...
	bool set_hook(struct tAttached process, void *dest, const char *func, const char *dll);

	// uninstalls an inline hook
	bool rem_hook(struct tAttached process, void *dest, const char *func, const char *dll);
